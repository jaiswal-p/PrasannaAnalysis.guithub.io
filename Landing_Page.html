                ...
                <div class="row">
                    <div class="col-sm-12 col-md-8">
                        <div class="box">
                            ...
                            <div class="box">
                            	<img src="output_11_0.png" alt="Latitude vs. Max Temperature" height="180" width="210" align="left">
                            	<p class="category"> The purpose of this project was to analyze how weather changes as you get closer to the equater. To accomplish this analysis. We first pulled data from the OpenWeatherMapAPI to assemble a dataset on over 500 cities. A super fun project to work on.
	                            </p>
                    ...
                    <div class="col-sm-12 col-md-4">
                        <div class="box">
                            ...
                            <div class="box">
                              <a href="./visualization-image-1.html"><img src="output_11_0.png" alt= "city Latitude vs Max Temperature" height="300" width="300"></a>
	                           <a href="./visualization-image-2.html"><img src="output_13_0.png" alt="Latitude vs. Humidity" height="300" width="300"></a>
	                           <a href="./visualization-image-3.html"><img src="output_15_0.png" alt="Latitude vs. Cloudiness" height="300" width="300"></a>
	                           <a href="./visualization-image-4.html"><img src="output_17_0.png" alt="Latitude vs. Wind Speed" height="300" width="300"></a>
	                        </div>
	                    </div>
	                </div>
	            </div>
